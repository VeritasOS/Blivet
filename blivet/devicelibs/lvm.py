...
#
# Modifications
#    2019-04-08: Changed the LVM call to ignore errors because it will fail the anaconda when the installation source are in local logic volume.
#
